...
#docker load --input
#
docker run --restart=always -d --name Samba -p 137:137 -p 139:139 -p 445:445 -v /home/$uservar/config/samba:/etc/smb -v /mnt:/mnt -v /home/$uservar/config/:/config -d mydomohome/docker-samba -n -u "$uservar;$passvar" -s "config;/config;yes;no;no;$uservar" -s "public;/mnt;yes;no;yes" -w "<$domvar>"
